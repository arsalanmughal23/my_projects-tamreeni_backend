    ...
    public function run()
    {
        $exercises = [
            ...
            [
                'user_id' => 2,
                'body_part_id' => 1,
                'name' => json_encode(['en' => __('messages.exercise_title', ['number' => 5], 'en'), 'ar' => __('messages.exercise_title', ['number' => 5], 'ar')]),
                ...
                'image' => 'https://tamreeni-backend.s3.amazonaws.com/Exercises/04.jpg',
                'video' => 'https://tamreeni-backend.s3.amazonaws.com/ExerciseVideos/04.mp4',
                'description' => json_encode(['en' => __('messages.exercise_description', ['number' => 5], 'en'), 'ar' => __('messages.exercise_description', ['number' => 5], 'ar')]),
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'user_id' => 2,
                'body_part_id' => 1,
                'name' => json_encode(['en' => __('messages.exercise_title', ['number' => 6], 'en'), 'ar' => __('messages.exercise_title', ['number' => 6], 'ar')]),
                'exercise_category_name' => Exercise::CATEGORY_ACCESSORY_MOVEMENT,
                'exercise_type_name' => null,
                'duration_in_m' => 40,
                'sets' => 3,
                ...
                'image' => 'https://tamreeni-backend.s3.amazonaws.com/Exercises/04.jpg',
                'video' => 'https://tamreeni-backend.s3.amazonaws.com/ExerciseVideos/04.mp4',
                'description' => json_encode(['en' => __('messages.exercise_description', ['number' => 6], 'en'), 'ar' => __('messages.exercise_description', ['number' => 6], 'ar')]),
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                'user_id' => 2,
                'body_part_id' => 1,
                'name' => json_encode(['en' => __('messages.exercise_title', ['number' => 7], 'en'), 'ar' => __('messages.exercise_title', ['number' => 7], 'ar')]),
                ...
                'image' => 'https://tamreeni-backend.s3.amazonaws.com/Exercises/04.jpg',
                'video' => 'https://tamreeni-backend.s3.amazonaws.com/ExerciseVideos/04.mp4',
                'description' => json_encode(['en' => __('messages.exercise_description', ['number' => 7], 'en'), 'ar' => __('messages.exercise_description', ['number' => 7], 'ar')]),
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                'user_id' => 2,
                'body_part_id' => 1,
                'name' => json_encode(['en' => __('messages.exercise_title', ['number' => 8], 'en'), 'ar' => __('messages.exercise_title', ['number' => 8], 'ar')]),
                ...
                'image' => 'https://tamreeni-backend.s3.amazonaws.com/Exercises/04.jpg',
                'video' => 'https://tamreeni-backend.s3.amazonaws.com/ExerciseVideos/04.mp4',
                'description' => json_encode(['en' => __('messages.exercise_description', ['number' => 8], 'en'), 'ar' => __('messages.exercise_description', ['number' => 8], 'ar')]),
                'created_at' => now(),
                'updated_at' => now(),
            ],
            // CATEGORY_CARDIO
            [
                'user_id' => 2,
                'body_part_id' => 1,
                'name' => json_encode(['en' => __('messages.exercise_title', ['number' => 9], 'en'), 'ar' => __('messages.exercise_title', ['number' => 9], 'ar')]),
                ...
                'image' => 'https://tamreeni-backend.s3.amazonaws.com/Exercises/04.jpg',
                'video' => 'https://tamreeni-backend.s3.amazonaws.com/ExerciseVideos/04.mp4',
                'description' => json_encode(['en' => __('messages.exercise_description', ['number' => 9], 'en'), 'ar' => __('messages.exercise_description', ['number' => 9], 'ar')]),
                'created_at' => now(),
                'updated_at' => now(),
            ]
        ];
