...
class MenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $menus = [
            ...
            ['name' => 'Slots', 'icon' => 'clock', 'slug' => 'slots', 'position' => 2, 'status' => 1],
            ['name' => 'Appointments', 'icon' => 'calendar-days', 'slug' => 'appointments', 'position' => 3, 'status' => 1],
            ...
            ['name' => 'Exercise Equipments', 'icon' => 'slash', 'slug' => 'exercise_equipments', 'position' => 9, 'status' => 1],
            ['name' => 'Body Parts', 'icon' => 'person-walking', 'slug' => 'body_parts', 'position' => 10, 'status' => 1],

            ['name' => 'Packages', 'icon' => 'folder', 'slug' => 'packages', 'position' => 11, 'status' => 1],
            ['name' => 'User Subscriptions', 'icon' => 'reorder', 'slug' => 'user_subscriptions', 'position' => 12, 'status' => 1],
            ['name' => 'Transactions', 'icon' => 'dollar', 'slug' => 'transactions', 'position' => 13, 'status' => 1],

            ['name' => 'Pages', 'icon' => 'file', 'slug' => 'pages', 'position' => 14, 'status' => 1],
            ['name' => 'Setting', 'icon' => 'cog', 'slug' => 'settings', 'position' => 15, 'status' => 1],
