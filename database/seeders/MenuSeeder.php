...
class MenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $menus = [
            ...
            ['name' => 'Appointments', 'icon' => 'glass', 'slug' => 'appointments', 'position' => 3, 'status' => 1],
            ['name' => 'Questions', 'icon' => 'glass', 'slug' => 'questions', 'position' => 4, 'status' => 1],
            ...
            ['name' => 'Exercises', 'icon' => 'glass', 'slug' => 'exercises', 'position' => 8, 'status' => 1],
