...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('name[en]', isset($bodyPart)?$bodyPart->getTranslation('name', 'en'):null, ['class' => 'form-control','maxlength' => 70, 'required']) !!}
</div>

<!-- Name Field -->
<div class="form-group col-sm-6">
    {!! Form::label('name', 'Name (Ar):', ['class'=>'required']) !!}
    {!! Form::text('name[ar]', isset($bodyPart)?$bodyPart->getTranslation('name', 'ar'):null, ['class' => 'form-control','maxlength' => 70, 'required', 'dir'=>'rtl']) !!}
</div>
