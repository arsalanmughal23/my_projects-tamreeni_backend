...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('title[en]', isset($question)?$question->getTranslation('title', 'en'):null, ['class' => 'form-control','maxlength' => 70, 'required', 'pattern'=>'[a-zA-Z0-9_.\s]{0,30}']) !!}
</div>

<!-- Title Ar Field -->
<div class="form-group col-sm-6">
    {!! Form::label('title', 'Title (Arabic):', ['class'=>'required']) !!}
    {!! Form::text('title[ar]', isset($question)?$question->getTranslation('title', 'ar'):null, ['class' => 'form-control','maxlength' => 70, 'required', 'dir'=>'rtl', 'pattern'=>'[a-zA-Z0-9_.\s]{0,30}']) !!}
</div>
