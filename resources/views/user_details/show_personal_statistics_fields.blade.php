    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-12" id="algo_required_calories">
                ...
                <p>{{ $userDetail->algo_required_calories }} Kcal</p>
            </div>
            ...
            @if(isset($personalStatistics))
                ...
                <div class="col-sm-12" id="current_day_required_calories">
                    ...
                    <p>{{ $personalStatistics['current_day_required_calories'] }} Kcal</p>
                </div>

                <!-- Time Required Field -->
                <div class="col-sm-12" id="workout_week_count">
                    {!! Form::label('workout_week_count', 'Time Required:') !!}
                    <p>{{ $personalStatistics['workout_week_count'] ?? 0 }} Week</p>
                </div>
                ...
                <div class="col-sm-12" id="current_week_target_calroies">
                    ...
                    <p>{{ $personalStatistics['current_week_target_calroies'] ?? 0 }} Kcal</p>
                </div>
                ...
                <div class="col-sm-12" id="current_week_consumed_calroies">
                    ...
                    <p>{{ $personalStatistics['current_week_consumed_calroies'] ?? 0 }} Kcal</p>
                </div>
            @endif
